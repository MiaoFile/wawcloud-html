...
<html lang="zh-cn">
    ...
    <body>
        ...
        <!-- Home Start -->
        <section class="bg-half-260 d-table w-100 bg-primary" style="background: url('https://api.miaomc.cn/image/get?4') top center;" id="home">
            <div class="bg-overlay"></div>
            <div class="container">
                <div class="row mt-5 justify-content-center">
                    <div class="col-12">
                        <div class="title-heading text-center">
                            <h4 class="heading text-white mb-3">联系我们</h4>
                            <p class="text-white-50 para-desc mx-auto mb-0">在这里，你能更快的联系我们</p>
                            <nav aria-label="breadcrumb" class="d-inline-block mt-4">
                                <ul class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="index.html">QAQ Cloud</a></li>
                                    <li class="btn btn-primary" aria-current="page">联系我们</li>
                                </ul>
                            </nav>
                        </div>
                    </div><!--end col-->
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="contact-detail text-center">
                            ...
                            <div class="content mt-4">
                                <h6 class="title text-uppercase font-weight-bold">联系电话</h6>
                    ...
                    <div class="col-md-4 mt-4 pt-2 mt-sm-0 pt-sm-0">
                        <div class="contact-detail text-center">
                            ...
                            <div class="content mt-4">
                                <h6 class="title text-uppercase font-weight-bold">电子邮箱</h6>
                                <p class="text-muted"></p>
                                <a href="mailto:znc15@tcbwork.com" class="text-primary">znc15@tcbwork.com</a>
                            </div>  
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-md-4 mt-4 pt-2 mt-sm-0 pt-sm-0">
                        <div class="contact-detail text-center">
                            ...
                            <div class="content mt-4">
                                <h6 class="title text-uppercase font-weight-bold">地区</h6>
                                <p class="text-muted"></p>
                                <a href="https://map.baidu.com/poi/%E5%8F%A4%E4%BA%AD%E6%9D%91/@13171865.128562689,3598937.0456269113,14.46z?uid=2f6c356432036ff5a2046410&ugc_type=3&ugc_ver=1&device_ratio=2&compat=1&pcevaname=pc4.1&newfrom=zhuzhan_webmap&querytype=detailConInfo&da_src=shareurl" class="text-primary">在百度地图中查看</a>
                            </div>  
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                            ...
                                            <input name="name" id="name" type="text" class="form-control" placeholder="您的名字 :">
                                        </div>
                                    </div><!--end col-->
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                            <label>您的邮箱 <span class="text-danger">*</span></label>
                                            <input name="email" id="email" type="email" class="form-control" placeholder="您的邮箱 :">
                                        </div> 
                                    </div><!--end col-->
                                    <div class="col-md-12">
                                        <div class="form-group position-relative">
                                            <label>什么问题？</label>
                                            <input name="subject" id="subject" type="text" class="form-control" placeholder="问题 ：">
                                        </div>                                                                               
                                    </div><!--end col-->
                                    <div class="col-md-12">
                                        <div class="form-group position-relative">
                                            <label>说明</label>
                                            <textarea name="comments" id="comments" rows="4" class="form-control" placeholder="您的说明 :"></textarea>
                                        </div>
                                    </div>
                                </div><!--end row-->
                                <div class="row">
                                    <div class="col-sm-12 text-right">
                                        <input type="submit" id="submit" name="send" class="submitBnt btn btn-primary" value="发送信息">
                    ...
                    <div class="col-12 p-0">
                        <div class="card map border-0">
                            <div class="card-body p-0">
                                <iframe src="https://map.baidu.com/poi/%E5%8F%A4%E4%BA%AD%E6%9D%91/@13171865.128562689,3598937.0456269113,14.46z?uid=2f6c356432036ff5a2046410&ugc_type=3&ugc_ver=1&device_ratio=2&compat=1&pcevaname=pc4.1&newfrom=zhuzhan_webmap&querytype=detailConInfo&da_src=shareurl" style="border:0" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
